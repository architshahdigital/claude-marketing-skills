...
│   │   ├── SKILL.md
│   │   └── references/citability-checklist.md
│   ├── ad-campaign-builder/
│   │   ├── SKILL.md
...
Each skill follows the standard `SKILL.md` format (YAML frontmatter with `name` + `description`, then the instructions). Drop a skill folder into your Claude skills directory to use it.

---

## 🧰 The expertise behind these

3+ years across D2C, e-commerce, and sports media — performance marketing (Meta & Google Ads), technical + on-page SEO, GEO/AEO, and AI-integrated content production. Certified in AEO & GEO, AI-Integrated SEO, and Digital Marketing (HubSpot).
...
**[LinkedIn](https://linkedin.com/in/architshahdigital)** · **[Portfolio](https://architshahdigital.com)** · ✉️ architshh10@gmail.com
